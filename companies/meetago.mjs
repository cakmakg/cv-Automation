...
export default {
  ...
  anschreiben: {
    ...
    paragraphs: [
      ...
      `Vertrieb bedeutet für mich, die richtigen Gesprächspartner zu finden, ihr Geschäft zu verstehen und einen guten Grund zu liefern, warum sich ein Gespräch lohnt — nicht möglichst viele Anrufe, sondern die relevanten. Aus meiner Selbstständigkeit und aus der Freelance-Betreuung mehrerer Supermärkte kenne ich Akquise und Kundenansprache aus der Praxis: Zielgruppen ansprechen, Angebote positionieren, mit Einwänden und Absagen umgehen und trotzdem dranbleiben. Dabei arbeite ich strukturiert und datengetrieben — Kampagnen über Facebook und Google Ads habe ich entlang klarer Kennzahlen wie Klickrate und Conversion ausgewertet und Schritt für Schritt verbessert. Dieses Denken in Funnel, Qualifizierung und sauberer Dokumentation übertrage ich direkt auf die Arbeit mit CRM- und Sales-Systemen.`,

      // Block 3 — Showcase (SaaS-/Produktverständnis)
      `Einen Vorteil bringe ich mit, den nur wenige im Vertrieb haben: Ich verstehe das Produkt, über das ich spreche, von innen. Ich baue selbst SaaS- und KI-Anwendungen, unter anderem eine autonome, KI-gestützte Reiseagentur mit echten Anbindungen an Flug-, Hotel- und Zahlungssysteme — also genau das Umfeld aus Reise, Gruppen und Buchung, in dem meetago unterwegs ist. In einem weiteren System orchestriere ich mehrere KI-Agenten, die Recherche und Ansprache über E-Mail und weitere Kanäle automatisieren. Dadurch kann ich mit Entscheidern auf Fach- und Managementebene auf Augenhöhe über Plattformen, Automatisierung und konkreten Nutzen sprechen, statt nur ein Skript abzulesen — gerade bei einem erklärungsbedürftigen, agentischen Produkt ein echter Hebel.`,

      // Block 4 — Value Proposition
      `Für Ihr Sales-Team bringe ich damit drei Dinge zusammen: den belastbaren, direkten Kundenkontakt aus Gastronomie und Tourismus, das datengetriebene Vorgehen aus dem Online-Marketing und ein echtes Verständnis für SaaS- und Plattformgeschäft. Mir ist wichtig, dass Outbound nicht nach Kaltakquise von der Stange klingt, sondern relevant, vorbereitet und nachvollziehbar ist — qualifizierte Termine, die für Ihre Kolleginnen und Kollegen im Vertrieb auch wirklich Wert haben.`,

      // Block 5 — Persönlichkeit + Abschluss-Einladung
      `Vor meinen Umschulungen zum Fachinformatiker und Full-Stack-Developer war ich in der Tourismusbranche tätig und habe anschließend ein eigenes Café- und Catering-Unternehmen in Bonn geführt. Im eigenen Betrieb habe ich gelernt, wie man Menschen gewinnt, auf Feedback reagiert und auch nach einem Nein weitermacht — und dass am Ende zählt, was tatsächlich beim Kunden ankommt. Ich arbeite mich schnell in neue Themen und Tools ein, übernehme gerne Verantwortung für Ergebnisse und würde als erste Stimme von meetago gerne neue Kundenbeziehungen aufbauen. Über die Einladung zu einem persönlichen Gespräch freue ich mich sehr.`,
    ],
  },
};
